...
DATA_FILE = os.path.join(STORAGE_DIR, "watermelons.json")

# Ensure storage directories and data file exist on startup
...
async def create_watermelon(payload: WatermelonCreate):
